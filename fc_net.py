...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #구조 순서가 affine-relu-affine이므로 그 순서에 맞춤
        ...
        dev[range(N), y]-=1     #dev=grad_loss
        #여기까지가 softmax 함수 통해서 얻을 수 있는 결과 하나하나 코드작성
        
        grad_relu, grads['W2'], grads['b2']=affine_backward(dev, cache_out)
        grads['W2']/=N
        grads['W2']+= self.reg*self.params['W2']
        grads['b2']/=N
        
        grad_a=relu_backward(grad_relu, cache_act)
        
        grads_x, grads['W1'], grads['b1'] = affine_backward(grad_a, cache_h)
        grads['W1']/=N
        grads['W1']+=self.reg*self.params['W1']
        grads['b1']/=N
        #각 파라미터와 활성함수 gradient backward 이용해 계산 정규화+regularizaion 포함
